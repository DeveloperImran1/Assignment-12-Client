                            ...
                            >
                                <SwiperSlide>
                                    <div className="relative group">
                                        ...
                                        <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                                            {/* love  */}
                                            {
                                        blogs?.[0]?.date &&   <button className="rounded-xl bg-[#0095FF] px-3 py-1 font-medium text-white duration-200 hover:bg-[#0095FF]/90">
                                        {formatDistanceToNow(new Date())} ago
                                    </button>
                                       }
                                        </div>

                                        <img width={300} height={370} className="h-[370px] w-full rounded-lg bg-black/40" src={blogs?.[0]?.image?.[0] || 'https://source.unsplash.com/300x300/?macbook'} alt="card navigate ui" />
                                ...
                                <SwiperSlide>
                                    <div className="relative group">
                                        ...
                                        <img width={300} height={370} className="h-[370px] w-full rounded-lg bg-black/40"  src={blogs?.[0]?.image?.[1]  || 'https://source.unsplash.com/300x300/?macbook'} alt="card navigate ui" />
                                        <div className=" size-1 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
                                ...
                                <SwiperSlide>
                                    <div className="relative group">
                                        ...
                                        <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                                       {
                                        ...
                                        <img width={300} height={370} className="h-[370px] w-full rounded-lg bg-black/40"  src={blogs?.[0]?.image?.[2]  || 'https://source.unsplash.com/300x300/?macbook'} alt="card navigate ui" />
                                        <div className=" size-1 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
...
<img className="w-[160px] h-[160px] absolute -right-11 -top-11  z-50" src="https://i.ibb.co/5X056tj/best-seller-vectors-982952-8827-1-removebg-preview.png" alt="" />
                        ...
                        <div className="p-6 space-y-2 lg:col-span-5">
                            ...
                            <h3 className="text-[16px]  font-[500px] sm:text-2xl group-hover:underline group-focus:underline">{blogs?.[0]?.title?.slice(0, 50)}</h3>
                            <span className="text-xs dark:text-gray-600">
                                
                                    {format(new Date(blogs?.[0]?.date), 'P')}
