...
const PostNow = ({refetch, handleSearch}) => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-between w-full gap-7">
            ...
            <form onChange={searchValue} className="flex items-center md:w-[30%] ">
                ...
                <div  className="inline-flex items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
