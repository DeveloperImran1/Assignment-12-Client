                ...
                <div className='flex justify-between' >
                    <div className='grid gap-7 grid-cols-2' >
                        ...
                        <div onClick={() => setPlace([23.81093000, 90.36542000])} className='w-[230px] h-[230px] cursor-pointer rounded-3xl bg-[#f3f4f6] hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center' >
                            ...
                            <h2 className='text-[19px] font-bold' >Gulshan 2</h2>
                            <h2 className='text-center px-3 mt-3' >Adjacent to Mirpur Local Market, heading to silver plaja.</h2>
                        </div>
                        <div onClick={() => setPlace([23.777176, 90.399452])} className='w-[230px] h-[230px] cursor-pointer md:mr-4  rounded-3xl bg-[#f3f4f6] hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center' >
                            <span className='p-3 rounded-full bg-white text-black' >
                                <RiHomeOfficeFill size={30} ></RiHomeOfficeFill>
                            </span>
                            <h2 className='text-[19px] font-bold' >Banani</h2>
                            <h2 className='text-center px-3 mt-3' >Near Banani Navar Bas, Blue Horijon Mall.</h2>
                        </div>
                        <div onClick={() => setPlace([23.873751, 90.396454])} className='w-[230px] h-[230px] cursor-pointer rounded-3xl bg-[#f3f4f6] hover:bg-[#076aa5] hover:text-white flex flex-col justify-center items-center' >
                            <span className='p-3 rounded-full bg-white text-black' >
                                <RiHomeOfficeFill size={30} ></RiHomeOfficeFill>
                            </span>
                            <h2 className='text-[19px] font-bold' >Uttara Sector</h2>
                            <h2 className='text-center px-3 mt-3' >Close the Central Park, toward Diamond Plaza.</h2>
                        </div>
