        ...
        <div>
            ...
            <div className=" mx-auto my-20 flex flex-col items-center justify-center md:flex-row">
                ...
                <div className="group relative  sm:w-[350px]">
                    <img width={350} height={350} className="h-[350px] w-[350px] scale-105 transform rounded-lg bg-black/70" src={adminData?.userPhoto || "https://source.unsplash.com/350x350/?men"} alt="Admin Profile" />
