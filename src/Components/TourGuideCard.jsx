...
const TourGuideCard = ({guide}) => {
    ...
    return (
        <Link to={`/tourGuide/${guide?.userEmail}`} key={guide._id} className="flex flex-col justify-center m-8 text-center ">
                            <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800 group">
                                <img src= {guide?.userPhoto || "https://source.unsplash.com/150x150/?portrait?3"} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square  " />
                                <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                                    <div className="my-2 space-y-1">
                                        <h2 className="text-xl font-semibold sm:text-2xl">{guide?.userName}</h2>
                                        <p className="px-5 text-xs sm:text-base dark:text-gray-600">{guide?.userRole}</p>
                                    </div>
