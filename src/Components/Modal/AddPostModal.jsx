...
const AddPostModal = ({ closeModal, isOpen, modalHandler, refetch }) => {
    ...
    const handleSubmit = async e => {
        ...
        if (photo) {
            ...
            setLoading(true)
            axiosSecure.post('/storys', addPostObj)
            .then(res => {
                            ...
                            <DialogPanel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                                ...
                                <form onSubmit={handleSubmit} >
                                    ...
                                    <label className="block mb-3">
                                        ...
                                        <input type="text" placeholder="Post Title here" name='title' className="block w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-violet-600 dark:bg-gray-100 " />
                                    </label>

                                    <label className="block mb-3">
                                        <span className="mb-1">Description</span>
                                        <textarea name='description' className="textarea block w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-violet-600 dark:bg-gray-100" placeholder="Add Your Experience"></textarea>
                                    </label>
